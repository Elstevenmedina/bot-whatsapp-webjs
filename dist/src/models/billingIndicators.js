...
const billingIndicatorsSchema = new mongoose_1.Schema({
...
const BillingIndicatorsModel = mongoose_1.default.model('indicadores_generales', billingIndicatorsSchema);
exports.default = BillingIndicatorsModel;
